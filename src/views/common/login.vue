    ...
    <div class="login-box">
      ...
      >
        <el-form-item prop="username">
          <el-input v-model="user.username" prefix-icon="iconfont iconuser"></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input type="password" v-model="user.password" prefix-icon="iconfont iconsuo"></el-input>
        </el-form-item>
